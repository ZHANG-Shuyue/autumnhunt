...
export default function StartMicrosoft() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-primary-cream/20 p-8 text-center">
      <h1 className="text-xl font-medium text-stone-700">Microsoft 授权（即将上线）</h1>
      <p className="mt-3 max-w-md text-sm text-stone-500">
        我们会通过 Microsoft OAuth 安全地获取你授权的 Outlook 只读权限，所有邮件解析在本地完成，不会上传任何邮件内容。
      </p>
